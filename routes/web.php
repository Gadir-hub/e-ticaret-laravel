...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard-seller', [OrderController::class, 'sellerDashboard'])->name('dashboard-seller'); // DÜZELTİLDİ
    ...
    Route::post('/notifications/{id}/mark-read', [OrderController::class, 'markAsRead'])->name('notifications.mark-read');
    Route::post('/notifications/mark-all-read', [OrderController::class, 'markAllAsRead'])->name('notifications.mark-all-read');
    Route::get('/notifications/list', [OrderController::class, 'notificationIndex'])->name('notifications.index');
    Route::delete('/notifications/clear', [OrderController::class, 'clearAll'])->name('notifications.clear');
});

// ------------------------
// API Routes (Bildirimler için)
// ------------------------
Route::middleware(['auth'])->prefix('api')->group(function () {
    Route::get('/notifications', [OrderController::class, 'getNotifications'])->name('api.notifications');
    Route::post('/notifications/{id}/read', [OrderController::class, 'markAsRead'])->name('api.notifications.read');
    Route::post('/notifications/read-all', [OrderController::class, 'markAllAsRead'])->name('api.notifications.read-all');
});
...
Route::controller(PageController::class)->group(function () {
    // Ana dashboard route'unu kaldırıyoruz veya korumalı yapıyoruz
    // Route::get('/', 'dashboardOverview1')->name('dashboard-overview-1');
    
    // Dashboard sayfalarını auth middleware'ine alalım
    Route::middleware(['auth'])->group(function () {
