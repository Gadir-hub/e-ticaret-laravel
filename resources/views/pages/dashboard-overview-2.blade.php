...
@section('subcontent')
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                <!-- BEGIN: Notification -->
                <div class="intro-y col-span-12 -mb-6 mt-6">
                    <x-base.alert
                        ...
                        <div class="box sm:flex">
                            <div class="flex flex-1 flex-col justify-center px-8 py-12">
                                <x-base.lucide
                                    ...
                                    icon="ShoppingBag"
                                />
                                <div class="relative ml-0.5 mt-12 pl-4 text-3xl font-medium">
                                    <span class="absolute left-0 top-0 -ml-0.5 text-2xl font-medium">
                                        $
                                    </span>
                                    54.143
                                </div>
                                <x-base.tippy
                                    class="mr-auto mt-3 flex cursor-pointer items-center rounded-full bg-success py-[3px] pl-2 pr-1 text-xs font-medium text-white"
                                    as="div"
                            ...
                            <div
                                class="flex flex-1 flex-col justify-center border-t border-dashed border-slate-200 px-8 py-12 dark:border-darkmode-300 sm:border-l sm:border-t-0">
                ...
                <div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3">
                    ...
                    <div @class([
                        'intro-y relative mt-5 relative',
                        "before:box before:absolute before:inset-x-3 before:mt-3 before:h-full before:bg-slate-50 before:content-['']",
                    ])>
                        <div class="box p-5">
                            ...
                            <div class="mb-2 mt-4 flex border-b border-slate-200 pb-2 text-xs text-slate-500">
                ...
                <div class="col-span-12 mt-6 lg:col-span-6">
                    <div class="box intro-y relative overflow-hidden bg-primary p-8">
                        ...
                        <img
                            class="absolute right-0 top-0 -mt-3 mr-2 hidden w-2/5 sm:block"
                ...
                <div class="col-span-12 mt-6 lg:col-span-6">
                    <div class="box intro-y relative overflow-hidden p-8">
                        ...
                        >
                            ...
                            />
                            <x-base.lucide
                                class="absolute bottom-0 right-0 top-0 my-auto mr-4 h-4 w-4"
                                icon="Copy"
                            />
                        </x-base.tippy>
                        <img
                            class="absolute right-0 top-0 -mr-12 mt-1 hidden w-1/2 sm:block"
                ...
                <div class="col-span-12 mt-6">
                    ...
                    <div class="intro-y mt-3 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                            ...
                            ...</x-base.pagination.link>
                            1</x-base.pagination.link>
                            2</x-base.pagination.link>
                            3</x-base.pagination.link>
                            ...</x-base.pagination.link>
