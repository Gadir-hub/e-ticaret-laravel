    ...
    <div class="intro-y mt-5 grid grid-cols-12 gap-5">
                    ...
                    >
                        ...
                        <div class="mt-5 rounded-md border border-slate-200/60 p-5 dark:border-darkmode-400">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="mt-3">
                                    Upload Image</x-base.form-label>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="intro-y box p-5">
                ...
                <div class="mt-3">
                    Post Date</x-base.form-label>
                    
                </div>
                <div class="mt-3">
                    Categories</x-base.form-label>
                    <x-base.tom-select
                        class="w-full"
                        id="post-form-3"
                        multiple
